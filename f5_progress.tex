...
$18$, $19$ and $20$ points}
\author{}
\date{August 5, 2026, second snapshot (level 17 in progress)}
...
$12534$ are already certified non-realizable at the time of this snapshot
($12518$ of them by circle-free searches taking six seconds in total);
the remaining $120$, which involve a circle stage (and include the only
two graphs without a $K_6$), are in the racing/slicing pipeline
(\texttt{results\_n17.json} is updated continuously). Independent
